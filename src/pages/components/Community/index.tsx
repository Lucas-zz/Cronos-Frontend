    ...
    return (
        <div className="xl:flex w-full relative z-10 pt-72 sm:pt-[400px]">
            <div className="flex-col xl:w-[60%]">
                <div className="flex justify-center xl:justify-start text-center xl:text-left font-dm opacity-60 font-medium tracking-widest leading-8 px-20 sm:px-0 uppercase">Community-owned and operated</div>
                <div className="flex text-center xl:text-left font-helve font-normal text-[50px] sm:text-[70px] md:text-[90px] leading-[80px] md:leading-[107px] text-transparent bg-clip-text bg-gradient-to-br from-white to-gray-500 px-5 md:px-10 xl:px-0 py-[49px]">Enter a Universe of Connected Services.</div>
                <div className="flex text-center xl:text-left font-dm font-normal text-[24px] md:text-[33px] leading-[43px] px-5 md:px-10 xl:px-0 xl:pr-10">
                ...
                <div className="sm:flex text-center pt-14 gap-16 text-xl sm:justify-center xl:justify-start">
                    <motion.button
