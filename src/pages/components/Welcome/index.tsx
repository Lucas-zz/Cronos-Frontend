...
export default function Welcome() {
    ...
    return (
        <div className="flex-col mt-28 relative">
            ...
            <span className="flex relative z-10 justify-center text-[50px] min-[480px]:text-[62px] sm:text-[80px] md:text-[100px] lg:text-[125px] xl:text-[153px] font-helve font-normal tracking-[0.02em] leading-[60px] sm:leading-[100px] lg:leading-[120px] xl:leading-[181px] py-24 sm:py-8 md:py-4 text-center text-transparent bg-clip-text bg-gradient-to-br from-white to-gray-500">The Internet of Blockchains</span>
