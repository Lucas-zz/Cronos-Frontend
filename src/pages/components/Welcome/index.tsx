...
export default function Welcome() {
    ...
    return (
        <div className="flex-col mt-28 relative max-w-screen-xl m-auto">
            <motion.div
                initial={{ x: "0%" }}
            ...
            >
                <Image src={hedron} className="absolute sm:-top-24 sm:left-18 w-48 h-48 md:w-60 md:h-60 lg:w-72 lg:h-72 filter blur-[3px] opacity-90 animate-blob" alt="Background image of a icosahedron in a floating animation" />
            </motion.div>
            ...
            >
                <Image src={hedron} className="absolute sm:-top-24 sm:left-18 w-48 h-48 md:w-60 md:h-60 lg:w-96 lg:h-96 filter blur opacity-90 animate-blob" alt="Background image of a icosahedron in a floating animation" />
            </motion.div>
        </div>
    );
}